...
use App\Modules\GestaoProjetos\Jobs\TrelloImportBoardJobs;
...
class ImportBoardTrelloBusiness extends BusinessAbstract implements ImportBoardTrelloBusinessContract
{
    ...
    public function enfileirarExportacaEXo(int $idProjeto, int $idEquipe): bool
    {
        $this->can(PermissionEnum::IMPORTAR_PROJETO_TRELLO->value);

        TrelloImportBoardJobs::dispatch($idProjeto, $idEquipe)->onQueue('board');
        return true;
