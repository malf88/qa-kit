...
class TrelloImportBoardJobs implements ShouldQueue
{
     ...
     * Execute the job.
     */
    public function handle(ImportBoardTrelloBusinessContract $importProjectTrelloBusiness): void
    {
        $importProjectTrelloBusiness->importar( $this->idProjeto,  $this->idEquipe);
    }
}
